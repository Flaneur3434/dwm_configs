#!/bin/sh
# Base16 Oribital - Shell color setup script
...
color02="5f/5f/5f" # Base 0B - Green
color03="94/94/94" # Base 0A - Yellow
color04="bc/bc/bc" # Base 0D - Blue
color05="e4/e4/e4" # Base 0E - Magenta
color06="ff/d7/af" # Base 0C - Cyan
color07="d7/af/87" # Base 05 - White
color08="af/87/5f" # Base 03 - Bright Black
color09="5f/87/d7" # Base 08 - Bright Red
color10="5f/87/af" # Base 0B - Bright Green
color11="87/af/d7" # Base 0A - Bright Yellow
color12="5f/af/ff" # Base 0D - Bright Blue
color13="00/87/d7" # Base 0E - Bright Magenta
color14="00/5f/af" # Base 0C - Bright Cyan
color15="00/00/d7" # Base 07 - Bright White
